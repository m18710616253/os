...
public class OOSDBTest2 {

	private final String BUCKET_FILE_URL = "/ibdata/ibdata2/bucket.txt";
	private final String OWNER_FILE_URL = "/ibdata/ibdata2/owner.txt";
	private final String OBJECT_FILE_URL = "/ibdata/ibdata2/";
	...
	public void exec(String[] args) {
		...
		for (int i = 0; i < 7; i++) {
			...
			new Thread() {
				public void run() {
					String fileName = "/ibdata/ibdata2/" + "object"
		...
		for (int i = 0; i < 7; i++) {
			...
			new Thread() {
				public void run() {
					String fileName = "/ibdata/ibdata3/" + "object"
							+ z.getAndIncrement() + ".txt";
					File objectFile = new File(fileName);
					if (objectFile.exists()) {
						objectFile.delete();
		...
		for (int i = 0; i < 6; i++) {
			...
			new Thread() {
				public void run() {
					String fileName = "/ibdata/ibdata10/" + "object"
							+ z.getAndIncrement() + ".txt";
					File objectFile = new File(fileName);
					if (objectFile.exists()) {
						objectFile.delete();
